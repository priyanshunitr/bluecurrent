...
const styles = StyleSheet.create({
  ...
  scheduledText: { color: '#E2E8F0', fontSize: 14, fontWeight: '600', marginTop: 20 },
  ...
  gasTitle: { color: '#94A3B8', fontSize: 13, fontWeight: '600', letterSpacing: 1 },
  gasValue: { color: '#FFFFFF', fontSize: 28, fontWeight: '700', marginTop: 4 },
  ...
  formTitle: { color: '#FFFFFF', fontSize: 18, fontWeight: '700', marginLeft: 12 },
  closeBtn: { padding: 4 },
  sectionLabel: { color: '#FFFFFF', fontSize: 14, fontWeight: '600', marginBottom: 12, marginTop: 10 },
  darkPickerContainer: {
  ...
  unitLabel: { color: '#64748B', fontSize: 10, fontWeight: '700', marginTop: 3, letterSpacing: 0.5 },
  typeSelector: { 
    flexDirection: 'row', 
    backgroundColor: '#001021', 
    borderRadius: 12, 
  ...
  dayText: { color: '#FFFFFF', fontSize: 11, fontWeight: '600' },
  ...
  addButtonText: { color: '#001A33', fontSize: 16, fontWeight: '700' },
  subSectionTitle: { fontSize: 16, fontWeight: '700', color: '#0F172A', marginBottom: 16 },
  ...
  scheduleTimeText: { fontSize: 16, fontWeight: '700', color: '#0F172A' },
